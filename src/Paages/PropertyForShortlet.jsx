...
setIsShuffled(true); // Mark as shuffled
      ...
      try {
        ...
        querySnapshot.forEach((doc) => {
          const data = doc.data();
          // Filter for Shortlet properties in JavaScript
          if (data.advertisingFor === 'Shortlet' && data.status === 'active') {
            propertiesData.push({
              id: doc.id,
              ...data,
              createdAt: data.createdAt?.toDate ? data.createdAt.toDate() : new Date(data.createdAt)
...
const PropertyCard = ({ property, viewMode = 'grid' }) => {
        ...
        <div>
          <div className='flex justify-between gap-2 sm:gap-4 mb-2 sm:mb-3 md:mb-4'>
            ...
            <div className="text-right flex-shrink-0">
              ...
              <div className="text-xs sm:text-sm text-gray-500">For Shortlet</div>
            </div>
          </div>
  ...
  <div className="text-sm text-gray-500">For Shortlet</div>
</div>
      </div>
...
export default PropertiesForShortlet;