    ...
    try {
      ...
      try {
        ...
        propertiesQuery = query(
          ...
          where('furnishingStatus', '==', 'Fully Furnished'),
          where('status', '==', 'active'),
...
setIsShuffled(true); // Mark as shuffled
      ...
      try {
        ...
        querySnapshot.forEach((doc) => {
          ...
          if (data.advertisingFor === 'Rent' && data.status === 'active' && data.propertyType === 'House' && data.propertyType === 'Apartment' && data.furnishingStatus === 'Fully Furnished') {
            propertiesData.push({
              id: doc.id,
              ...data,
              createdAt: data.createdAt?.toDate ? data.createdAt.toDate() : new Date(data.createdAt)
...
export default FurnishedForRent;